    ...
    <div class="row">
      <div class="col-md-12">
        <div class="for-group text-center">
          <img src="<?=BASE?>/assets/images/deaconpay.png" alt="Paypay icon">
          <p class="p-t-10"><small><?=sprintf(lang("you_can_deposit_funds_with_deaconpay_they_will_be_automaticly_added_into_your_account"), 'DeaconPay')?></small></p>
        </div>
